        ...
        while (args.length > 0) {
            ...
            switch (v) {
                ...
                case "--help":
                    ...
                    console.log('   --coverage Generate a coverage report and print it to the screen (you must intrument your own files with YUITest first)');
                    console.log('   --coverage-warn <Number> The percentage to highlight as low coverage');
                    process.exit();
                    break;
                case "-v":
                case "--version":
